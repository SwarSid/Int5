...
.block-container{padding-top:0 !important;padding-bottom:2rem;margin-top:0 !important}
...
/* Fix nav button text visibility */
div[data-testid="stButton"] button p {color:#1E293B !important;font-weight:600 !important}
div[data-testid="stButton"] button[kind="secondary"] p {color:#1E293B !important}
...
/* Make st.tabs labels fully visible */
...
# ── Sidebar ───────────────────────────────────────────────────────────────────
with st.sidebar:
    st.markdown("**HCP Conversion Atlas** · ICI v3.0")
...
# ── Nav ───────────────────────────────────────────────────────────────────────
# ── Tabs (native Streamlit — no CSS needed) ──────────────────────────────
...
with tab1:
    view_overview.render(eng, hcps, filter_bar)
with tab2:
    view_integrated.render(eng, hcps, filter_bar)
with tab3:
    view_clusters.render(eng, hcps, filter_bar)
with tab4:
    view_qualitative.render(eng, hcps, filter_bar)
with tab5:
    view_envelope.render(eng, hcps, filter_bar)
